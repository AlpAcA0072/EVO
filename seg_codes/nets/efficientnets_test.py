...
from nets.efficientnets import default_cfgs
...
def _create_effnet(variant, pretrained=False, **kwargs):
    ...
    # kwargs.pop('num_features', 0)
    # kwargs.pop('head_conv', None)
    # kwargs.pop('head_bias', None)
...
if __name__ == "__main__":
    net = mobilenetv2_100(pretrained=False)
    net.cuda()
    net.eval()
