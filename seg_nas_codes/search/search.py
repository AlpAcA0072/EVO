...
def main(args):
    ...
    # ----------------------- Multi-Objective Surrogate-Assisted Evolutionary Search ----------------------- #
    # construct the search engine
    from search.msunas import MSuNAS

    engine = MSuNAS(search_space, evaluator, args.sec_obj, args.surrogate,
                    save_path=args.save_path, resume=args.resume)
